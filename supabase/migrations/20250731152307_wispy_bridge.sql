/*
  ...
  This function allows creating reservations with elevated privileges,
  bypassing RLS restrictions for the specific use case of public reservations.
*/

-- Create a function to handle reservation creation with elevated privileges
...
BEGIN
  ...
  VALUES (
    (reservation_data->>'full_name')::text,
