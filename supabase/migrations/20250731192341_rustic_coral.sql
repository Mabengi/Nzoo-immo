/*
  # Update RPC function to match actual table structure

  This migration recreates the RPC function to work with the actual
  table structure after column names have been standardized.
*/

-- Drop the existing function
DROP FUNCTION IF EXISTS create_reservation_admin(jsonb);

-- Create the RPC function that matches the actual table structure
