/*
  # Fix SQL syntax error and create proper RPC functions

  1. Create RPC functions for updating and deleting reservations
  2. Add proper RLS policies for UPDATE and DELETE operations
  3. Grant necessary permissions

  This migration fixes the unterminated comment error and provides working functions.
*/
