/*
  # Fix column name mapping in RPC functions

  1. Disable RLS completely on reservations table
  2. Create working RPC functions that map to correct column names
  3. Ensure all operations work properly
  4. Add test data if needed

  This migration fixes the column name mapping issue.
*/
...
-- Create RPC function for creating reservations with correct column mapping
...
BEGIN
  ...
  -- Use direct INSERT with correct column names (with underscores)
