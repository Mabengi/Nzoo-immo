/*
  # Debug and fix RPC function for date handling

  This migration creates a new version of the RPC function with better
  date handling and debugging to ensure dates are properly saved.
*/

-- Drop the existing function
DROP FUNCTION IF EXISTS create_reservation_admin(jsonb);

-- Create the corrected RPC function with better date handling
